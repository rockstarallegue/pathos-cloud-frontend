        ...
        <div class="q-pa-none full child container">
            ...
            <div class="full-width q-pa-none row">
                ...
                <div class="col-2 text-center q-pa-xs">
                    <q-btn push size="md" dense icon="alt_route" class="text-dark-blue q-pa-none q-px-xs inset-font"/>
                </div>
            </div>
            ...
            <div class="fit q-pa-none">
                <q-scroll-area flat class="full child container rounded-2">
                    <div class="full q-pa-md">
                        <div 
                            v-for="(tag, n) in tags_array" 
                            :key="n"
                            class="q-pa-none q-mb-sm"
                        >
                            <div class="light-1-glass q-pa-none row rounded-2">
                                <div class="col-10 q-pa-none full child container">
                                    <div class="fit row q-pa-none">
                                        <BranchNester :enabled="false"/>
                                    </div>
                                </div>
                            </div>
                        </div>
...
import BranchNester from 'src/components/PathCard/Actions/Nesters/BranchNester.vue'

export default defineComponent({
  components: { BranchNester },
  name: 'BranchSection',
  data () {
      return {
          enabled: 2,
